...
print(f"|Great Circle Distance Calculator|")
print(f"|Circle Radius: {r:<17}|")
print(f"|Starting point latitude: {lat1:<7}|")
print(f"|Starting point longitude: {log1:<6}|")
print(f"|Ending point latitude: {lat2:<9}|")
print(f"|Ending point longitude: {log2:<8}|")
print(f"|Great Circle Distance: {gcdistance:<9.2f}|")