...
print(f"|Starting point latitude: {lat1}|")
print(f"|Starting point longitude: {log1}|")
print(f"|Ending point latitude: {lat2}|")
print(f"|Ending point longitude: {log2}|")
print(f"|Great Circle Distance: {round(gcdistance, 2)}|")